...
public class forget extends JFrame implements ActionListener, MouseListener {
    ...
    private JLabel join, studentid, confirmpassword, password, welcome, coursePlanner, nameLabel, depLabel, email;
    private JLabel aiub;
    private JTextField student, studentname, emailtf;
    private JPasswordField confirmpass, pass;
    private JButton login, signup, confirm;
