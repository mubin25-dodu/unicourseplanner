...
// setContentPane(scrollPane);
    ...
    public void displayCompletedCourseContentAsLabels() {
        ...
        String fileContent = readFileContent("Files/completedcourse.txt");
...
private void clearFileContent(File file) {
    ...
    private void moveRunningToComplete() {
        // Define file paths
        File sourceFilePath = new File("Files/running.txt");
        File destinationFilePath = new File("Files/complete.txt");
    
        // Read content from the running file
        String fileContent = readFileContent(sourceFilePath.getPath());
    
        // Append the content to the complete file
        appendDataToFile(destinationFilePath, fileContent);
    
        // Clear the content of the running file
        clearFileContent(sourceFilePath);
    }
